...
class IPTMSPackageDetailServiceTest {
		...
		void testGetIPTreatmentPackageByAilmentCategoryAndName() {
			...
			IPTreatmentPackages iPTreatmentPackage2 = new IPTreatmentPackages();
		
			when(iptmsPackageDetail.findByName("Package 1", "c1")).thenReturn(iPTreatmentPackage1);
			when(iptmsPackageDetail.findByName("Package 2", "c2")).thenReturn(iPTreatmentPackage2);
			when(iptmsPackageDetail.findByName("Package 2", "c3")).thenReturn(null);
			assertEquals(iPTreatmentPackage1, iPTMSPackageDetailService.getIPTreatmentPackageByAilmentCategoryAndName("package1", "c1"));
		assertEquals(iPTreatmentPackage2, iPTMSPackageDetailService.getIPTreatmentPackageByAilmentCategoryAndName("package2", "c2"));

			assertThrows(PackageDetailNotFoundException.class, ()-> iPTMSPackageDetailService.getIPTreatmentPackageByAilmentCategoryAndName("package2", "c3"));
		}
