...
class TreatmentPlanControllerTest {
	...
	public void testGetAllPatients() throws Exception {
		...
		mvc.perform(get("/patients")).andExpect(status().isOk()).andExpect(jsonPath("$", Matchers.hasSize(2)))
	...
	public void testGetAllTreatmentPlans() throws Exception {
		...
		mvc.perform(get("/treatmentplans")).andExpect(status().isOk()).andExpect(jsonPath("$", Matchers.hasSize(2)))
	...
	public void testGetTreatmentPlanById() throws Exception {
		...
		mvc.perform(get("/treatmentplan/2")).andExpect(status().isOk())
	...
	public void testGetTeatmentPlan1() throws Exception {
        ...
        mvc.perform(post("/formTimeTable").contentType(MediaType.APPLICATION_JSON).characterEncoding("utf-8")
	...
	public void testPatientNotFoundException() throws Exception{
		...
		mvc.perform(get("/patient/7" , exceptionParam)
	...
	public void testTreatmentPlanNotFoundException() throws Exception{
		...
		mvc.perform(get("/treatmentplan/7" , exceptionParam)
				.contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isNotFound())
